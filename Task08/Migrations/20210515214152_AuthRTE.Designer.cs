...
namespace Task08.Migrations
{
    ...
    [Migration("20210515214152_AuthRTE")]
    partial class AuthRTE
    {
            ...
            modelBuilder.Entity("Task08.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(1996, 5, 16, 0, 41, 51, 904, DateTimeKind.Local).AddTicks(4467),
                            FirstName = "Jakub",
                            LastName = "Nowak"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2000, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6452),
                            FirstName = "Michal",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 3,
                            BirthDate = new DateTime(1994, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6499),
                            FirstName = "Patient",
                        ...
                        {
                            IdPatient = 4,
                            BirthDate = new DateTime(1999, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6507),
                            FirstName = "Sergio",
                            LastName = "Kotowich"
                        },
                        new
                        {
                            IdPatient = 5,
                            BirthDate = new DateTime(1971, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6511),
                            FirstName = "Ala",
                            LastName = "Peronska"
                        },
                        new
                        {
                            IdPatient = 6,
                            BirthDate = new DateTime(1992, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6521),
                            FirstName = "Kot",
                            LastName = "Zygmund"
                        },
                        new
                        {
                            IdPatient = 7,
                            BirthDate = new DateTime(1967, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6525),
                            FirstName = "Natiel",
                            LastName = "Patient"
                        },
                        new
                        {
                            IdPatient = 8,
                            BirthDate = new DateTime(1954, 5, 16, 0, 41, 51, 907, DateTimeKind.Local).AddTicks(6529),
                            FirstName = "Jas",
                            LastName = "Profase"
                        });
                });
            ...
            modelBuilder.Entity("Task08.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2021, 5, 16, 0, 41, 51, 927, DateTimeKind.Local).AddTicks(7524),
                            DueDate = new DateTime(2021, 8, 14, 0, 41, 51, 927, DateTimeKind.Local).AddTicks(8238),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2021, 5, 16, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(3),
                            DueDate = new DateTime(2021, 8, 14, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(19),
                            IdDoctor = 1,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2021, 5, 16, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(24),
                            DueDate = new DateTime(2021, 8, 14, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(27),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2021, 5, 16, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(31),
                            DueDate = new DateTime(2021, 8, 14, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(34),
                            IdDoctor = 3,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 5,
                            Date = new DateTime(2021, 5, 16, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(37),
                            DueDate = new DateTime(2021, 8, 14, 0, 41, 51, 928, DateTimeKind.Local).AddTicks(41),
                            IdDoctor = 3,
                            IdPatient = 2
                        });
                });
